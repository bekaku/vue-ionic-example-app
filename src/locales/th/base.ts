export default {
    'base': {
        ...
        'pleaseWaitWhileLoadingMoreData': 'กำลังโหลดข้อมูลเพิ่มเติม...',
        'pleaseWaitWhileLoading': 'กรุณารอซักครู่ระบบกำลังประมวลผล',
        'deleteConfirm': 'ยืนยันการลบข้อมูล',
        'deletePhotoConfirm': 'ยืนยันการลบรูปภาพนี้',
        'changePassword': 'เปลี่ยนรหัสผ่าน',
        'changeAvatar': 'เปลี่ยนรูปประจำตัว',
        'viewAvatar': 'ดูรูปประจำตัว',
        'viewCover': 'ดูรูปคัฟเวอร์',
        ...
        'termAcceptText2': 'ข้อกำหนดในการให้บริการ และ นโยบายความเป็นส่วนตัว ของ Vue Ionic',
        'continue': 'ต่อไป',
        'previous': 'ก่อนหน้า',
        ...
        noViewerForThisFile: 'ไม่สามารถเปิดไฟล์ได้',
        noViewerForThisFileHelp: 'ผู้ใช้สามารถทำการดาวน์โหลดไฟล์แล้วใช้แอพอื่นในเครื่องเพื่อเปิดไฟล์ได้ หรือทำการแชร์ไฟล์นี้ไปยังแอพอื่นเพื่อเปิดไฟล์ได้',
    },
    'theme': {
        'light': 'กลางวัน',
        'dark': 'กลางคืน',
    ...
    'authen': {
        ...
        'forgot_pwd_title': 'กรอกที่อยู่อีเมล์ที่ได้ลงทะเบียนไว้กับระบบ Vue Ionic',
