...
export const permissionListApi: ApiListResponse<Permission> = {
    dataList: [
        {
            id: 1,
...
export const userListApi: ApiListResponse<UserDto> = {
    dataList: userItems,
    totalPages: 100,
    totalElements: 20000,
    last: false,
...
export const dashBaordStatisticItems: LabelValue<string>[] = [
    {
        ...
        icon: { name: biCurrencyDollar, iconSet: 'bootstrap-icons' },
    },
    {
        label: 'Subscriptions',
        value: '+2350',
    ...
    },
    {
        ...
        icon: { name: biCreditCard, iconSet: 'bootstrap-icons' },
    },
    {
        label: 'Active Now',
        value: '+573',
        description: '+201 since last hour',
        icon: { name: biGraphUp, iconSet: 'bootstrap-icons' },
    },
];
...
export const dashboardChartData: ISeriresCategories = {
    ...
    series: [
        {
            name: 'Access',
            data: [32, 26, 57, 21, 8, 69, 14, 39, 10, 7, 9, 25],
        },
        {
            name: 'Post',
            data: [10, 58, 30, 21, 27, 100, 9, 40, 20, 10, 50, 12],
        },
        {
            name: 'Repost',
            data: [8, 10, 15, 21, 4, 75, 10, 50, 84, 0, 9, 25],
        },
        {
            name: 'Comment',
            data: [11, 20, 12, 14, 80, 10, 51, 22, 30, 10, 31, 11],
        },
        {
            name: 'Feel',
            data: [20, 10, 40, 16, 60, 5, 19, 1, 5, 0, 1, 4],
        },
        {
            name: 'Share',
            data: [1, 10, 61, 21, 17, 36, 51, 30, 15, 24, 56, 8],
        },
        {
            name: 'Read',
            data: [75, 38, 75, 70, 3, 2, 45, 35, 9, 6, 11, 24],
        },
        {
            name: 'Learn',
            data: [22, 0, 3, 92, 45, 11, 31, 20, 22, 10, 12, 21],
        },
        {
            name: 'Reward',
            data: [30, 1, 13, 71, 0, 0, 3, 0, 3, 0, 20, 15],
        },
    ],
};
...
export const dashboardHeroItems: LabelValue<string>[] = [
    {
        ...
        to: '/example/feed',
        icon: { name: biNewspaper, iconSet: 'bootstrap-icons' },
    },
    {
        label: 'Chats',
    ...
    },
    {
        ...
        to: '/example/charts',
        icon: { name: biBarChart, iconSet: 'bootstrap-icons' },
    },
];
...
export const chatMessageListApi: ApiListResponse<GroupChatMsgDto>
= {
    dataList: [
        {
            id: 667,
