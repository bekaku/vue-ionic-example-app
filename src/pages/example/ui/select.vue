...
<template>
  <BasePage page-title="Select" fullscreen show-back-link>
    <BaseCard title="Dialog/Item">
      <IonCardContent class="q-gutter-md">
        <BaseButton
          ...
          full
           :icon=" { name: chevronExpandOutline, iconSet: 'ion' }"
          @click="dialog1 = true"
        />
        <BaseSelectItem
          v-model="itemSingle"
        ...
        />
        <BaseSelectItem
          v-model="itemMultiple"
          :items="simpleItems2"
          multiple
          label="Select multiple user"
        />
        <BaseSelectItem
          v-model="itemMultiple2"
          :items="simpleItems"
          multiple
    ...
    <BaseTextHeader title="Inline Single select" />
    <BaseSelect
      v-model="singleModel"
      :items="simpleItems"
      :multiple="false"
    ...
    >
      <template #top>
        <div class="q-pa-md">Selected : {{ singleModel }}</div>
      </template>
    </BaseSelect>

    <BaseTextHeader title="Inline Multiple select" />
    <BaseSelect
    ...
    >
      <template #top>
        <div class="q-pa-md">Selected : {{ multipleModel }}</div>
      </template>
    </BaseSelect>
